...
export function Listings() {
  ...
  useEffect(() => {
    document.title = mode ? `${mode.heading} | Providence Estates` : 'All Listings | Providence Estates';
  }, [mode]);
    ...
    <div className="pt-28">
      <div className="mx-auto max-w-7xl px-6 pt-8 lg:px-10">
        ...
        <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-ink/60">
          {mode ? mode.description : 'Browse the full Providence portfolio across Dubai — for sale and to let.'}
        </p>
